...
const Edit_types = () => {
    ...
    const update = async () => { 
        try {
            await axiosInstance.put(`http://localhost:8080/api/v1/type/edit/${type.id}`, {
                typee: type.typee,
                        ...
                        <div className="card-body">
                            <form>
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="text" className="form-control" name="typee" value={type.typee} onChange={handleChange} />
                                </div>
                                <br/>
