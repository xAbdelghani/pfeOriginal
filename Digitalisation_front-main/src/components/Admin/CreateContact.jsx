...
const Createcontact = () => {
    const [compagnieId, setCompagnieId] = useState(''); // Récupère l'ID de la compagnie depuis l'URL
    ...
    const handleOk = async (event) => {
        ...
        try {
            ...
            setTimeout(() => navigate(`/admin/contactall`), 2000); // Redirige vers la liste des contacts de la compagnie
        } catch (err) {
                            ...
                            <div className="form-group">
                               ...
                               />
                                ...
                                <div className="box-footer text-center">
                                    ...
                                    <button type="button" className="btn btn-secondary" onClick={() => navigate(`/admin/Contactall`)}style={buttonStyle}>Annuler</button>
                                </div>
                            </form>
                        </div>
                    </div>
