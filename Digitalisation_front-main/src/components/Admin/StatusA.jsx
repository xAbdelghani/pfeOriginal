...
const StatusA = () => {
    ...
    const [statutAIdToDelete, setStatutAIdToDelete] = useState(null);
    ...
    function handleEditstatutA(statutA) {
        navigate("/admin/EditSt", { state: { statutA } });
    }

    async function deletestatutA() {
        setAlertVisible(true);
        await axiosInstance.delete("http://localhost:8080/api/v1/statutA/delete/" + statutAIdToDelete);
    ...
    async function modell(statutAId) {
        setModalVisible (true);
        setStatutAIdToDelete(statutAId);
    }
    ...
    return (
        <>
            ...
            <div className="container">
                ...
                <Table
    columns={columns}
    dataSource={statutAs ? statutAs.map((statutA) => ({ ...statutA, key: statutA.id })) : []}
