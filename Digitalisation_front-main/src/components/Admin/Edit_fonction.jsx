...
const Edit_fonctions = () => {
    ...
    const recuperation = () => {
        const { fonction } = location.state; 
        setFonction(fonction);
    };

    const update = async () => {
        try {
            await axiosInstance.put(`http://localhost:8080/api/v1/fonction/edit/${fonction.id}`, {
                qualite: fonction.qualite,
            ...
            <div className="container">
                ...
                <div className="row justify-content-center">
                    <div className="col-lg-6 col-md-6 col-sm-6 card">
                        <h1 className="text-center"> Mise à jour Fonction</h1>
                        <div className="card-body">
                            <form>

                                <div className="form-group">
                                    <label className="text-center">Caractéristique </label>
                                    <input type="text" className="form-control" name="qualite" value={fonction.qualite} onChange={handleChange} />
                                </div>
