...
const Create_Offres = () => {
    ...
    const [offres, setUsers] = useState([]);
    ...
    async function save(event) {
        ...
        try {
            await axiosInstance.post("http://localhost:8080/api/v1/offre/save", {
                libelle: libelle,
            ...
            <div className="container">
                ...
                <div className="row justify-content-center">
                    <div className="col-lg-6 col-md-6 col-sm-6 card">
                        <h1 className="text-center">Nouvelle Offre</h1>
                        <div className="card-body">
                            <form>
                            <div className="form-group">
                            {errors.libelle && <div style={{ color: 'red' }}>{errors.libelle}</div>}
                                    <label className="text-center"> Libelle</label>
                                    <input type="text" className="form-control" value={libelle} onChange={(event) => setLibelle(event.target.value)} placeholder="Entrez Fonction" />
                                </div>
