...
const Create_contact = () => {
    ...
    const handleOk = async (event) => {
        ...
        try {
            ...
            setTimeout(() => navigate(`/admin/contacts/${compagnieId}`), 2000); // Redirige vers la liste des contacts de la compagnie
        } catch (err) {
                            ...
                            <div className="form-group">
                               ...
                               />
                                ...
                                <div className="box-footer text-center">
                                    ...
                                    <button type="button" className="btn btn-secondary" onClick={() => navigate(`/admin/contacts/${compagnieId}`)}style={buttonStyle}>Annuler</button>
                                </div>
                            </form>
                        </div>
                    </div>
