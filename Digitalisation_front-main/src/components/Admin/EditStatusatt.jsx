...
const Edit_StatutAtt = () => {
    ...
    const recuperation = () => {
        const { statutAtt } = location.state; 
        setStatutAtt(statutAtt);
    };

    const update = async () => {
        try {
            await axiosInstance.put(`http://localhost:8080/api/v1/statutAtt/edit/${statutAtt.id}`, {
                libelles: statutAtt.libelles,
              
            });
            navigate("/admin/StatutA");
                        ...
                        <div className="card-body">
                            ...
                            <br/>
                                <div className="form-group">
                                    ...
                                    <input type="text" className="form-control" name="libelles" value={statutAtt.libelles} onChange={handleChange} />
                                </div>
                                <br /> 
