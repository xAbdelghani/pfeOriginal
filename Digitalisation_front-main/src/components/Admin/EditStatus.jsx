...
const Edit_StatutAs = () => {
    ...
    const recuperation = () => {
        const { statutA } = location.state; 
        setStatutA(statutA);
    };

    const update = async () => {
        try {
            await axiosInstance.put(`http://localhost:8080/api/v1/statutA/edit/${statutA.id}`, {
                libellep: statutA.libellep,
                        ...
                        <div className="card-body">
                            ...
                            <br/>
                                <div className="form-group">
                                    ...
                                    <input type="text" className="form-control" name="libellep" value={statutA.libellep} onChange={handleChange} />
                                </div>
                                <br /> 
