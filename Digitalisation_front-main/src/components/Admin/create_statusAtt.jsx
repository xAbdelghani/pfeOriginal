...
const Create_StatutAtt = () => {
    ...
    const validate = () => {
        const newErrors = {};
        if (!libelles) newErrors.libelles = "* Ce champ est obligatoire";
    ...
    async function save(event) {
        ...
        try {
            await axiosInstance.post("http://localhost:8080/api/v1/statutAtt/save", {
                        ...
                        <div className="card-body">
                            <form>
                                ...
                                {errors.libelle && <div style={{ color: 'red' }}>{errors.libelle}</div>}
                                    ...
                                    <input type="text" className="form-control" value={libelles} onChange={(event) => setLibelles(event.target.value)} placeholder="Entrez Libelle" />
                                </div>
                                <br />
...
export default Create_StatutAtt;
