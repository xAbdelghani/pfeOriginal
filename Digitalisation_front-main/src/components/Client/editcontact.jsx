                        ...
                        <div className="card-body">
                            ...
                            <div className="form-group">
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="text" className="form-control" name="prenomc" value={contact.prenomc} onChange={handleChange} />
                                </div>
                               ...
                               <br/>
                                ...
                                <div className="box-footer">
                                    ...
                                    <span style={{ margin: '0 100px' }}></span>
                                        ...
                                        <button type="button" className="btn btn-secondary" onClick={() => navigate(`/client/Contact`)}>Annuler</button>
